...
- [ENGLISH VERSION](#index-EN)
- [ITALIAN VERSION](#indice-IT)
___
## <a id="index-EN"></a>Index EN
...
For more details, we recommend reading the [Thesis](https://github.com/cirovitale/TRACE/blob/main/thesis/CiroVitale_BachelorThesis_2023.pdf), in Italian.
___
...
___
## System Requirements
- **Memory**: minimum of 16 GB RAM to support in-memory loading of ML models.
...
1. **Download and Configure Assets**
    - Download the [TRACE_ML_ASSETS](https://shorturl.at/abuN4) archive containing the directories, `models` and `vectorizers`.
...
Per maggiori approfondimenti si consiglia la lettura della [Tesi](https://github.com/cirovitale/TRACE/blob/main/thesis/CiroVitale_BachelorThesis_2023.pdf), in italiano.
___
...
- **Memoria**: minimo di 16 GB RAM per supportare il caricamento in memoria dei modelli di ML.
...
1. **Download e Configurazione Assets**
    - Scaricare l'archivio [TRACE_ML_ASSETS](https://shorturl.at/abuN4) contenente le directory, `models` e `vectorizers`.
